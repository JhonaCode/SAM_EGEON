...
#LIB_NETCDF=/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf/4.7.4/lib
#INC_NETCDF=/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf/4.7.4/include

LIB_NETCDF=/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf-fortran/4.5.3/lib
INC_NETCDF=/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf-fortran/4.5.3/include/

#--cflags        -> -I/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf/4.7.4/include -I/opt/ohpc/pub/libs/gnu9/openmpi4/hdf5/1.10.8/include
#--libs          -> -L/opt/ohpc/pub/libs/gnu9/openmpi4/netcdf/4.7.4/lib -lnetcdf


FF77=${compi} -c -ffixed-line-length-none -extend_source
FF90=${compi} -c -ffree-line-length-0 

CC=${compic} -c  -DLINUX
FFLAGS =  -O2
FFLAGS += -I${INC_NETCDF} ###-I/opt/ohpc/pub/libs/gnu9/openmpi4/hdf5/1.10.8/include
LD = ${compi}
LDFLAGS = -L${LIB_NETCDF} -lnetcdff
